...
class VectorStoreService:
    def __init__(self, host: str, port: int):
        ...
        if settings.TESTING:
            ...
            chroma_settings.chroma_api_impl = "chromadb.api.segment.SegmentAPI"
            chroma_settings.chroma_sysdb_impl = "chromadb.db.impl.sqlite.SqliteDB"
            chroma_settings.chroma_producer_impl = "chromadb.db.impl.sqlite.SqliteDB"
            chroma_settings.chroma_consumer_impl = "chromadb.db.impl.sqlite.SqliteDB"
            chroma_settings.persist_directory = None
            self.client = chromadb.EphemeralClient(chroma_settings)
        else:
