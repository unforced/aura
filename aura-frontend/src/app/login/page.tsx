...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Create form data as required by FastAPI's OAuth2PasswordRequestForm
      ...
      // Redirect to dashboard or documents page
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:block relative w-0 flex-1">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center">
          <div className="max-w-md text-white text-center px-8">
            ...
            <p className="text-blue-100 text-lg leading-relaxed">
              Upload your documents and unlock the power of AI-driven question answering. 
              Get instant insights from your knowledge base.
            </p>
